...
summary: Überprüfen Sie die von Google Cloud heruntergeladene Datei disk.raw mithilfe von OpenSSL anhand des Inhalts der Digest-Datei. 
---
...
[role="lead"]
Sie können die von Google Cloud heruntergeladene Datei disk.raw mit dem Inhalt der Digest-Datei vergleichen, der über die https://mysupport.netapp.com/site/products/all/details/cloud-volumes-ontap/downloads-tab["NSS"^] mit OpenSSL.
...
----
====
. Legen Sie die heruntergeladene Datei disk.raw, die Signatur und die Zertifikate in einem Verzeichnis ab.
. Extrahieren Sie den öffentlichen Schlüssel mithilfe von OpenSSL aus dem Zertifikat.
