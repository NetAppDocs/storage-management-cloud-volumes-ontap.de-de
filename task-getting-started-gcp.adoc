...
Wenn Sie keinen haben https://docs.netapp.com/us-en/bluexp-setup-admin/concept-connectors.html["Konsolenagent"^] Dennoch müssen Sie einen erstellen. https://docs.netapp.com/us-en/console-setup-admin/task-install-agent-google-gcloud.html["Erfahren Sie, wie Sie einen Konsolenagenten in Google Cloud erstellen"^]
...
[role="quick-margin-para"]
https://cloud.google.com/apis/docs/getting-started#enabling_apis["Aktivieren Sie Google Cloud APIs in Ihrem Projekt"^]. https://docs.netapp.com/us-en/console-setup-admin/task-install-agent-google-gcloud.html#step-5-enable-google-cloud-apis["Diese APIs"^], die Sie möglicherweise bereits im Rahmen der Erstellung des Console-Agenten aktiviert haben, sind für die Bereitstellung von Cloud Volumes ONTAP in Google Cloud erforderlich.
