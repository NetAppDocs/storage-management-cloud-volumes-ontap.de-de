...
.Schritte
. Wählen Sie im linken Navigationsmenü *Lizenzen und Abonnements* aus.
...
----
. Geben Sie bei der entsprechenden Aufforderung den gesamten kopierten Text ein, einschließlich und von `----- BEGIN CERTIFICATE -----` Zu `----- END CERTIFICATE -----` .
