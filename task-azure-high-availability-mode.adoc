...
Die NetApp Konsole fordert Sie zur Eingabe dieser Details auf, wenn die Funktion für ein Azure-Abonnement aktiviert werden muss.

Beachten Sie Folgendes:

* Es gibt keine Probleme mit der Hochverfügbarkeit Ihres Cloud Volumes ONTAP HA-Paares.  Diese Azure-Funktion arbeitet mit ONTAP zusammen, um die vom Client beobachtete Anwendungsausfallzeit für NFS-Protokolle zu reduzieren, die sich aus ungeplanten Failover-Ereignissen ergibt.
