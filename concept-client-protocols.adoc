...
Ab ONTAP Version 9.12.1 wird NVMe-TCP von allen Cloud-Anbietern unterstützt.  Cloud Volumes ONTAP unterstützt NVMe-TCP als Blockprotokoll für Storage VMs (SVMs) während der Bereitstellung und installiert die erforderlichen NVMe-Lizenzen automatisch.

Die NetApp Console bietet keine Verwaltungsfunktionen für NVMe-TCP.
