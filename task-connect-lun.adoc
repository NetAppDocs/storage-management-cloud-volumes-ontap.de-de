...
summary: Wenn Sie ein iSCSI-Volume erstellen, erstellt die NetApp Konsole automatisch eine LUN für Sie.  Wir haben es einfach gemacht, indem wir nur eine LUN pro Volume erstellt haben, sodass keine Verwaltung erforderlich ist.  Nachdem Sie das Volume erstellt haben, verwenden Sie den IQN, um von Ihren Hosts aus eine Verbindung mit der LUN herzustellen. 
---
...
[role="lead"]
Wenn Sie ein iSCSI-Volume erstellen, erstellt die NetApp Konsole automatisch eine LUN für Sie.  Wir haben es einfach gemacht, indem wir nur eine LUN pro Volume erstellt haben, sodass keine Verwaltung erforderlich ist.  Nachdem Sie das Volume erstellt haben, verwenden Sie den IQN, um von Ihren Hosts aus eine Verbindung mit der LUN herzustellen.
