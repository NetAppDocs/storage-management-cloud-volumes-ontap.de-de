...
* https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-convert-node-capacity.html["Konvertieren Sie knotenbasierte Lizenzen in kapazitätsbasierte"^]
