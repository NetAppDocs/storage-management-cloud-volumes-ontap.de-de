...
summary: Mit der NetApp Konsole können Sie Volumes und CIFS-Server verwalten.  Außerdem werden Sie aufgefordert, Volumes zu verschieben, um Kapazitätsprobleme zu vermeiden. 
---
...
.. Klicken Sie unter „Volume-Aktionen“ im Bereich „Volumes verwalten“ auf „Volume klonen“.
