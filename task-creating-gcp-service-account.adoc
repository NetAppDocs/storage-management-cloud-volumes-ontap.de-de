...
.Schritte
. In der Google Cloud Console https://console.cloud.google.com/iam-admin/serviceaccounts["Gehen Sie zur Seite „Dienstkonten“"^].
...
+
image:screenshot_gcp_service_account_grant_access.gif["Ein Screenshot der Google Cloud Console, in der Sie Nutzern während der Erstellung Zugriff auf ein Servicekonto gewähren."]
