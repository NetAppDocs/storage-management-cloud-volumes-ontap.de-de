...
---
= Informationen zu Cloud Volumes ONTAP node-based BYOL
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
link:concept-licensing.html["Erfahren Sie mehr über Cloud Volumes ONTAP -Lizenzen"].
...
Knotenbasierte Lizenzen können von NetApp bezogen werden. Die Anzahl der Lizenzen, die Sie für ein Einzelknotensystem oder ein HA-Paar erwerben können, ist unbegrenzt.
