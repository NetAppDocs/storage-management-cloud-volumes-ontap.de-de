...
* Die NetApp Konsole erstellt bei der Bereitstellung von Cloud Volumes ONTAP eine datenbereitstellende Speicher-VM.  Einige Konfigurationen unterstützen zusätzliche Speicher-VMs. link:task-managing-svms.html["Erfahren Sie mehr über die Verwaltung von Speicher-VMs"] .
+
