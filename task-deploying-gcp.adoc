...
** Das mit dem Console-Agenten verknüpfte Dienstkonto https://docs.netapp.com/us-en/console-setup-admin/reference-permissions-gcp.html["sollte über die erforderlichen Berechtigungen verfügen"^]
...
| Projekt bearbeiten  a| 
Wählen Sie das Projekt aus, in dem Cloud Volumes ONTAP residieren soll.
...
. *HA-Bereitstellungsmodelle*: Wählen Sie mehrere Zonen (empfohlen) oder eine einzelne Zone für die HA-Konfiguration. Wählen Sie dann eine Region und eine Zone aus.
+
