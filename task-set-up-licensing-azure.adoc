...
+
Nachdem NetApp Ihnen das private Angebot mitgeteilt hat, können Sie bei der Systemerstellung den Jahresplan auswählen, wenn Sie ihn im Azure Marketplace abonnieren.
