...
Basierend auf Ihrer Konfiguration und dem Lizenztyp können Sie mithilfe der APIs mehrere Storage-VMs auf einem Einzelknotensystem oder in einer Hochverfügbarkeitskonfiguration (HA) erstellen.
...
.Bevor Sie beginnen
Der Konsolenagent benötigt bestimmte Berechtigungen zum Erstellen von Speicher-VMs für Cloud Volumes ONTAP HA-Paare. Die erforderlichen Berechtigungen sind enthalten in https://docs.netapp.com/us-en/console-setup-admin/reference-permissions-gcp.html["die von NetApp bereitgestellten Richtlinien"^] Die



=== Einzelknotensystem

Verwenden Sie den folgenden API-Aufruf, um eine Storage-VM auf einem Single-Node-System zu erstellen.
...
.Bevor Sie beginnen
Der Konsolenagent benötigt bestimmte Berechtigungen zum Verwalten von Speicher-VMs für Cloud Volumes ONTAP HA-Paare. Die erforderlichen Berechtigungen sind enthalten in https://docs.netapp.com/us-en/console-setup-admin/reference-permissions-gcp.html["die von NetApp bereitgestellten Richtlinien"^] Die
...
.Schritte
* Verwenden Sie den folgenden API-Aufruf, um eine Storage-VM auf einem Einzelknotensystem umzubenennen:
+
...
.Schritte
* Verwenden Sie den folgenden API-Aufruf, um eine Storage-VM auf einem Einzelknotensystem zu löschen:
+
