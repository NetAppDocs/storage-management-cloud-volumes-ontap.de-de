...
Basierend auf Ihrer Konfiguration und dem Lizenztyp können Sie mithilfe der APIs für die NetApp Console mehrere Storage-VMs auf einem Einzelknotensystem oder in einer Hochverfügbarkeitskonfiguration (HA) erstellen.
...
== Verwalten Sie Storage-VMs auf Einzelknotensystemen und HA-Paaren
