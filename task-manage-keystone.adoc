...
. Wählen Sie im Menü der NetApp Console *Administration > Licenses and subscriptions*.
. Wählen Sie * Keystone -Abonnements* aus.
. Wählen Sie für das Abonnement, das Sie verknüpfen möchten, image:icon-action.png["Ein Symbol, das aus drei nebeneinander liegenden Punkten besteht"] und wählen Sie *Verknüpfen* aus.
...
. Wählen Sie im Menü der NetApp Console *Administration > Licenses and subscriptions*.
. Wählen Sie * Keystone -Abonnements* aus.
. Wählen Sie für das Abonnement, dessen Kapazität Sie anpassen möchten, image:icon-action.png["Ein Symbol, das aus drei nebeneinander liegenden Punkten besteht"] und wählen Sie *Details anzeigen und bearbeiten*.
. Geben Sie die angeforderte zugesagte Kapazität für ein oder mehrere Abonnements ein.
. Scrollen Sie nach unten, geben Sie gegebenenfalls weitere Details für die Anfrage ein und wählen Sie dann *Submit*.
...
. Wählen Sie im Menü der NetApp Console *Administration > Licenses and subscriptions*.
. Wählen Sie * Keystone*.
. Wählen Sie für das Abonnement, das Sie entkoppeln möchten, image:icon-action.png["Ein Symbol, das aus drei nebeneinander liegenden Punkten besteht"] und wählen Sie *Entkoppeln* aus.
