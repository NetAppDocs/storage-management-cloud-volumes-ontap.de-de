...
* Essentials Single Node: Lese-/Schreib-Volumes, die auf einem Cloud Volumes ONTAP System unter Verwendung nur eines ONTAP Knotens erstellt wurden.
...
Unter *Verwaltung > Lizenzen und Abonnements* können Sie sehen, dass 50 TiB von der _Essentials Single Node_-Lizenz abgezogen werden.
