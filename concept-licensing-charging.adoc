...
* Wenn Sie eine BYOL-Lizenz und einen Jahresvertrag von einem Marktplatz besitzen, werden Ihr Verbrauch und etwaige Mehrkosten gemäß der von Ihnen festgelegten Abrechnungspräferenz berechnet. Um zu verstehen, wie Sie abgerechnet werden, siehe link:concept-licensing-charging.html#billing-preferences-and-overages["Abrechnungseinstellungen und Überschreitungen"].
* Nur Einzelknotensysteme mit BYOL werden in China-Regionen unterstützt. Bereitstellungen in China-Regionen sind von den BYOL-Lizenzbeschränkungen ausgenommen.
...
Bei kapazitätsbasierter Lizenzierung ist die maximale Anzahl von Cloud Volumes ONTAP-Systemen auf 24 pro NetApp Console-Organisation beschränkt. Ein  ist ein Cloud Volumes ONTAP HA-Paar, ein Cloud Volumes ONTAP Einzelknotensystem oder eine beliebige zusätzliche Speicher-VM, die Sie erstellen. Die Standard-Speicher-VM wird nicht auf das Limit angerechnet. Dieses Limit gilt für alle Lizenzmodelle.
...
+
Dieses System zählt als zwei Systeme: eines für das Einzelknotensystem und eines für die zusätzliche Storage-VM.
...
Im Abschnitt * Licenses and subscriptions* in der Konsole können Sie auswählen, wie die Abrechnung erfolgen soll. Überschreitungen entstehen, wenn Ihre Nutzung die in Ihrem Lizenzpaket oder Jahresabonnement festgelegte Kapazität überschreitet.

* * NetApp -Lizenzen zuerst*: Bei diesem Modell wird Ihre Nutzung zunächst auf die Kapazität Ihres Lizenzpakets (BYOL) angerechnet. Wenn Sie Ihre Lizenzkapazität überschreiten, werden die Mehrkosten auf Basis Ihres jährlichen Marktplatz-Abonnements oder Ihrer stündlichen Marktplatz-Abrechnungssätze (PAYGO) berechnet. Wenn Ihre BYOL-Lizenz abläuft, müssen Sie über die Cloud-Marktplätze auf ein kapazitätsbasiertes Lizenzierungsmodell umsteigen. Weitere Informationen finden Sie unter link:task-convert-node-capacity.html["Konvertieren Sie eine knotenbasierte Cloud Volumes ONTAP -Lizenz in eine kapazitätsbasierte Lizenz"]Die
* *Nur für Marketplace-Abonnements*: Bei diesem Modell wird Ihre Nutzung zunächst über Ihr jährliches Marketplace-Abonnement abgerechnet. Jegliche zusätzliche Nutzung wird zu den stundenweisen On-Demand-Tarifen des Marktplatzes abgerechnet (PAYGO). Nicht genutzte Lizenzkapazität wird bei der Abrechnung nicht berücksichtigt.


Weitere Informationen zu den Abrechnungseinstellungen finden Sie unter https://docs.netapp.com/us-en/console-licenses-subscriptions/concept-billing-preferences.html["Erfahren Sie mehr über die Abrechnungseinstellungen für Lizenzen und Abonnements."^]Die
...
Informationen zu den Gebühren für Essentials-Lizenzen finden Sie unterlink:concept-licensing-charging.html#essentialscharging["Essentials-Pakete"] Die
...
* link:concept-licensing.html["Lizenzierung für Cloud Volumes ONTAP"]
* link:task-manage-capacity-licenses.html["Verwalten Sie die kapazitätsbasierte Lizenzierung für Cloud Volumes ONTAP"]
* link:task-manage-node-licenses.html["Knotenbasierte Lizenzierung verwalten"]
* link:task-convert-node-capacity.html["Konvertieren Sie eine knotenbasierte Lizenz in eine kapazitätsbasierte Lizenz"]
* link:task-manage-keystone.html["Keystone -Abonnements verwalten"]
