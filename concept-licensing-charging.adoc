...
* Wenn Sie eine BYOL-Lizenz und einen Jahresvertrag von einem Marktplatz besitzen, werden Ihr Verbrauch und etwaige Mehrkosten gemäß der von Ihnen festgelegten Abrechnungspräferenz berechnet. Um zu verstehen, wie Sie abgerechnet werden, siehe link:concept-licensing-charging.html#concept-licensing-charging.html#billing-preferences-and-overages["Abrechnungseinstellungen und Überschreitungen"].
