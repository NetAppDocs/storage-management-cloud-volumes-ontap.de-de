...
* *Nutzungsübersicht*: Dieser Bericht fasst die gesamte in Ihrem Konto verbrauchte Kapazität zusammen und schlüsselt sie nach Abrechnungsmethode auf (vorab reservierte Lizenzen im Vergleich zu nutzungsbasierter Abrechnung). Es sind die folgenden Informationen enthalten:
+
[cols="1,2"]
|===
| Spalte | Beschreibung 
...
| Gesamte verbrauchte Kapazität | Die gesamte bereitgestellte Kapazität aller Cloud Volumes ONTAP Systeme in Ihrem Konto. 


| Gesamte vorab festgelegte Kapazität | Die gesamte von Ihnen bei NetApp erworbene Lizenzkapazität, einschließlich sowohl BYOL-Lizenzen als auch Marketplace-Verträgen. Dieser Wert ist die Summe der gesamten BYOL-Kapazität und der gesamten Marketplace-Vertragskapazität. 


| Gesamte BYOL-Kapazität | Der Anteil der vorab zugesagten Kapazität, der durch Bring Your Own License (BYOL)-Lizenzen abgedeckt ist, die direkt von NetApp erworben wurden. 


| Gesamtkapazität der Marketplace-Verträge | Der Anteil der vorab zugesagten Kapazität, der durch jährliche Marktplatzverträge oder private Angebote abgedeckt ist, die über den Marktplatz Ihres Cloud-Anbieters erworben wurden. 


| Gesamte PAYGO-Kapazität | Der Teil der verbrauchten Kapazität, der nicht durch eine vorab zugesagte Lizenz abgedeckt ist und zu Pay-as-you-go (PAYGO) Stundensätzen auf dem Marktplatz abgerechnet wird. 
|===
* *Cloud Volumes ONTAP Paketnutzung*: Dieser Bericht bietet die gleiche Kapazitätsaufschlüsselung wie der High-level usage report, jedoch nach Lizenzpaketen gegliedert. Es sind die folgenden Informationen enthalten:
+
[cols="1,2"]
|===
| Spalte | Beschreibung 
...
| Gesamte verbrauchte Kapazität | Die gesamte für dieses Paket bereitgestellte Kapazität über alle Cloud Volumes ONTAP Systeme in Ihrem Konto. 


| Gesamte vorab festgelegte Kapazität | Die gesamte lizenzierte Kapazität dieses von Ihnen bei NetApp erworbenen Pakets, einschließlich sowohl BYOL-Lizenzen als auch Marketplace-Verträgen. Dieser Wert ist die Summe der gesamten BYOL-Kapazität und der gesamten Kapazität der Marketplace-Verträge. 


| Gesamte BYOL-Kapazität | Der Anteil der vorab zugesagten Kapazität für dieses Paket, der durch Bring Your Own License (BYOL)-Lizenzen abgedeckt ist, die Sie direkt von NetApp erworben haben. 


| Gesamtkapazität der Marketplace-Verträge | Der Anteil der vorab zugesagten Kapazität für dieses Paket, der durch jährliche Marktplatzverträge oder private Angebote abgedeckt ist, die über den Marktplatz Ihres Cloud-Anbieters erworben wurden. 


| Gesamte PAYGO-Kapazität | Der Anteil der verbrauchten Kapazität dieses Pakets, der nicht durch eine vorab zugesagte Lizenz abgedeckt ist und zu Pay-as-you-go (PAYGO) Stundensätzen auf dem Marktplatz abgerechnet wird. 
|===
...
| System-ID und Name | Die eindeutige Kennung (UUID) und der Anzeigename des Cloud Volumes ONTAP Systems. 


| Wolke | Der Cloud-Anbieter, bei dem das System bereitgestellt wird (z. B. AWS, Azure oder Google Cloud). 


| NetApp Konto-ID | Die Kennung für das mit dem System verknüpfte NetApp-Konto. 


| Systemkonfiguration | Die Bereitstellungskonfiguration des Systems (z. B. Einzelknoten oder HA Pair). 


| SVM-Name | Der Name der Storage Virtual Machine (SVM) innerhalb des Cloud Volumes ONTAP Systems. 


| Bereitgestellte Kapazität | Die auf dem SVM bereitgestellte Gesamtkapazität. 


| Übersicht der geladenen Kapazität | Die tatsächlich für die SVM abgerechnete Kapazität. Jede SVM verfügt über eine minimale abrechnungsfähige Kapazität (standardmäßig 4 TiB, wobei dieser Wert je nach Konto variieren kann). Liegt die bereitgestellte Kapazität der SVM auf oder unter diesem Minimum, wird dieser Wert auf das Minimum aufgerundet, andernfalls entspricht er der bereitgestellten Kapazität. 


| Abrechnungszeitraum für den Marktplatz | Der Abrechnungszeitraum für das zugehörige Marketplace-Abonnement (zum Beispiel stündlich oder jährlich). 


| Cloud Volumes ONTAP Paket oder -Funktion | Das mit der SVM verbundene Lizenzpaket oder Feature (zum Beispiel Essentials oder Professional). 


| Name des SaaS Marketplace-Abonnements wird aufgeladen | Der Name des für die Abrechnung verwendeten Marktplatzabonnements. 


| Abrechnung der SaaS Marketplace-Abonnement-ID | Die eindeutige Kennung des Marketplace-Abonnements, die für die Abrechnung verwendet wird. 


| Arbeitslasttyp | Gibt an, ob die Volumes der SVM *Primär* (lesen/schreiben) sind und aktiv für Produktionsdaten verwendet werden oder *Sekundär* (DP), also Datensicherungs-Zielvolumes wie SnapMirror-Replikate, die für Backup und Replikation genutzt werden. 
|===
...
| System-ID und Name | Die eindeutige Kennung (UUID) und der Anzeigename des Cloud Volumes ONTAP Systems, das das Volume enthält. 


| SVM-Name | Der Name der Storage Virtual Machine (SVM), die das Volume enthält. 


| Datenträger-ID | Die eindeutige Kennung des Volumes. 


| Datenträgertyp | Der Volume-Typ (zum Beispiel lesen/schreiben oder Datenschutz). 


| Vom Volumen bereitgestellte Kapazität | Die für das Volume bereitgestellte Gesamtkapazität. 
|===
+
...
* https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-licensing.html["Lizenzierung für Cloud Volumes ONTAP"^]
* https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-licensing-charging.html["Erfahren Sie mehr über kapazitätsbasierte Lizenzen"^]
* https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-manage-node-licenses.html["Knotenbasierte Lizenzierung verwalten"^]
* https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-convert-node-capacity.html["Konvertieren Sie eine knotenbasierte Lizenz in eine kapazitätsbasierte Lizenz"^]
* https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-manage-keystone.html["Keystone -Abonnements verwalten"^]
