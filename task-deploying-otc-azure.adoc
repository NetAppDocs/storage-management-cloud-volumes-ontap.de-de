...
---
= Cloud Volumes ONTAP mit fortschrittlichen Methoden in Azure bereitstellen
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
NOTE: Wenn für die ausgewählte Version eine neuere Release Candidate-, General Availability- oder Patch-Version verfügbar ist, aktualisiert Console das System beim Erstellen der Arbeitsumgebung auf diese Version. Beispielsweise erfolgt die Aktualisierung, wenn Sie Cloud Volumes ONTAP 9.16.1 P3 auswählen und 9.16.1 P4 verfügbar ist. Das Update erfolgt nicht von einer Version zur nächsten – beispielsweise von 9.15 auf 9.16.
...
+
Diese Option ist nur für bestimmte VM-Typen verfügbar. Welche VM-Typen unterstützt werden, ist unter link:link:reference-configs-azure.html#ha-pairs["Unterstützte Konfigurationen nach Lizenz für HA-Paare"] zu finden.
...
+
link:link:reference-configs-azure.html#ha-pairs["Erfahren Sie mehr über unterstützte Konfigurationen in Azure"^].
