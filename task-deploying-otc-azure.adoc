...
summary: Sie können ein einzelnes Cloud Volumes ONTAP -System in Azure starten, indem Sie in der NetApp Konsole ein Cloud Volumes ONTAP -System erstellen. 
---
...
[role="lead"]
Sie können ein Einzelknotensystem oder ein HA-Paar in Azure starten, indem Sie in der NetApp Konsole ein Cloud Volumes ONTAP -System erstellen.
