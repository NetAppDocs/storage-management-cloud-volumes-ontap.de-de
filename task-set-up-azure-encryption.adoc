...
.Schritte
. Die Liste der Schlüsseltresore in Ihrem Azure-Abonnement erhalten Sie mithilfe der folgenden API-Aufrufe.
+
https://docs.netapp.com/us-en/console-automation/cvo/get-azure-ha-metadata-keys-vault.html["Für ein HA-Paar"^]: `GET /azure/ha/metadata/vaults`

+
https://docs.netapp.com/us-en/console-automation/cvo/get-azure-vsa-metadata-keys-vault.html["Für einen einzelnen Knoten"^]: `GET /azure/vsa/metadata/vaults`
...
+
Für ein HA-Paar: `GET /azure/ha/metadata/keys-vault?resourceGroupName=KeyVaultResourceGroup&vaultName=KeyVault`

+
Für einen einzelnen Knoten: `GET /azure/vsa/metadata/keys-vault?resourceGroupName=KeyVaultResourceGroup&vaultName=KeyVault`
...
+
.. Für ein HA-Paar verwenden Sie  https://docs.netapp.com/us-en/console-automation/cvo/post-azure-ha-working-environments.html["dieser API-Aufruf"^]:
+
...
.. Für ein Einzelknotensystem verwenden Sie  https://docs.netapp.com/us-en/console-automation/cvo/post-azure-vsa-working-environments.html["dieser API-Aufruf"^]:
+
...
* https://docs.netapp.com/us-en/console-automation/cm/wf_cvo_before.html["Bereiten Sie sich auf die Verwendung der Cloud Volumes ONTAP API-Workflows vor."^].
* https://docs.netapp.com/us-en/bluexp-automation/cm/api_ref_resources.html#azure-haworking-environments["Erfahren Sie mehr über die ONTAP-Management-REST-APIs"^].
