...
[cols="3*"]
|===
|  | Azure-Marktplatz | NetApp Konsole 
...
| *Orchestrierungsfunktionen* | Nicht verfügbar | Verfügbar über die NetApp Konsole, basierend auf dem Lizenztyp 
...
* https://docs.netapp.com/us-en/bluexp-family/index.html["Dokumentation zur NetApp -Konsole"^]
