...
| Vollständiges Angebot an VM-Typen. link:reference-configs-azure.html["Unterstützte Konfigurationen in Azure"] 
...
| *Unterstützter Datenträgertyp* | Verwaltete Premium-SSD-v2-Datenträger | Breitere Unterstützung. link:reference-configs-azure.html#azure-storage-for-user-data["Unterstützte Datenträgertypen in Azure"] 
