...
+
--
Die NetApp Konsole erstellt für jedes System einen einzelnen S3-Bucket und nennt ihn Fabric-Pool-_Cluster Unique Identifier_.  Es wird nicht für jedes Volume ein anderer S3-Bucket erstellt.

Wenn die Konsole den S3-Bucket erstellt, verwendet sie die folgenden Standardeinstellungen:

* Lagerklasse: Standard
