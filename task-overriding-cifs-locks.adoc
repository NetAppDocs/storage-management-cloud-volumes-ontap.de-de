...
summary: Der Organisations- oder Kontoadministrator kann in der NetApp Konsole eine Einstellung aktivieren, die Probleme mit der Rückgabe von Cloud Volumes ONTAP -Speicher während Azure-Wartungsereignissen verhindert.  Wenn Sie diese Einstellung aktivieren, blockiert Cloud Volumes ONTAP CIFS-Sperren und setzt aktive CIFS-Sitzungen zurück. 
---
...
[role="lead"]
Der Organisations- oder Kontoadministrator kann in der NetApp Konsole eine Einstellung aktivieren, die Probleme mit der Rückgabe von Cloud Volumes ONTAP -Speicher während Azure-Wartungsereignissen verhindert.  Wenn Sie diese Einstellung aktivieren, blockiert Cloud Volumes ONTAP CIFS-Sperren und setzt aktive CIFS-Sitzungen zurück.
