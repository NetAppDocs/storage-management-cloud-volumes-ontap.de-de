...
+
link:https://www.netapp.com/pdf.html?item=/media/9088-tr4383["NetApp Technical Report 4383: Leistungscharakterisierung von Cloud Volumes ONTAP in Amazon Web Services mit Anwendungs-Workloads"^]
