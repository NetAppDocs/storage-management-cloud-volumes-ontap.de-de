...
Wenn Sie Cloud Volumes ONTAP in AWS starten möchten, müssen Sie in der NetApp Konsole ein neues System erstellen.
...
+
** https://docs.netapp.com/us-en/bluexp-classification/concept-cloud-compliance.html["Erfahren Sie mehr über die NetApp Datenklassifizierung"^]
...
** Wenn Sie eine gp3- oder io1-Festplatte auswählen, verwendet die Konsole die Elastic Volumes-Funktion in AWS, um die zugrunde liegende Speicherfestplattenkapazität nach Bedarf automatisch zu erhöhen.  Sie können die anfängliche Kapazität basierend auf Ihrem Speicherbedarf auswählen und sie nach der Bereitstellung von Cloud Volumes ONTAP überarbeiten. link:concept-aws-elastic-volumes.html["Erfahren Sie mehr über die Unterstützung für Elastic Volumes in AWS"^] .
