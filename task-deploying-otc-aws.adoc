...
---
= Cloud Volumes ONTAP mit fortschrittlichen Optionen in AWS bereitstellen
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
CAUTION: Ändern Sie nach Abschluss des Bereitstellungsprozesses nicht die systemgenerierten Cloud Volumes ONTAP -Konfigurationen im AWS-Cloud-Portal, insbesondere nicht die System-Tags. Alle an diesen Konfigurationen vorgenommenen Änderungen können zu unerwartetem Verhalten oder Datenverlust führen.
