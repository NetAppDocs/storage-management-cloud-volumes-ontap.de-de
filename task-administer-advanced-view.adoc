...
* ONTAP S3 Objektspeicherverwaltung: ONTAP S3 Speicherverwaltungsfunktionen in Cloud Volumes ONTAP sind nur im System Manager und nicht in der Console verfügbar.
...
* https://docs.netapp.com/us-en/ontap/concept_administration_overview.html["Informationen zur Clusterverwaltung mit ONTAP System Manager"^]
