...
summary: Cloud Volumes ONTAP umfasst ein Cluster-Administratorkonto.  Sie können das Kennwort für dieses Konto bei Bedarf über die NetApp Konsole ändern. 
---
...
[role="lead"]
Cloud Volumes ONTAP umfasst ein Cluster-Administratorkonto.  Sie können das Kennwort für dieses Konto bei Bedarf über die NetApp Konsole ändern.
