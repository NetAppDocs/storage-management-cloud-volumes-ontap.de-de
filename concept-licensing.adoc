...
* link:link:reference-configs-azure.html["Unterstützte Konfigurationen in Azure"]
...
* link:link:reference-configs-gcp.html["Unterstützte Konfigurationen in Google Cloud"^]
...
Keystone Subscriptions werden mit HA-Paaren unterstützt. Diese Lizenzierungsoption wird derzeit nicht mit Single-Node-Systemen unterstützt.
...
* link:concept-licensing-charging.html["Erfahren Sie mehr über kapazitätsbasierte Lizenzen"]
