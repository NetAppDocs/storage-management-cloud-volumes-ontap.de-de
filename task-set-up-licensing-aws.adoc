...
== Festlegung der bevorzugten Abrechnung für einen eigenständigen AWS-Eintrag

Wenn Sie ein eigenständiges AWS-Abonnement mit Ihrem AWS-Konto verknüpft haben, können Sie Cloud Volumes ONTAP über dieses Abonnement bezahlen. Wenn Sie außerdem NetApp Intelligent Services (NIS) Abonnements haben, können Sie Ihre Datendienste über das mit dem NIS-Abonnement verknüpfte Paket bezahlen. Für bestehende Abonnements empfiehlt NetApp, auf das eigenständige Abonnementmodell umzusteigen, um die Kosten Ihrer Cloud Volumes ONTAP Nutzung besser zu verwalten.

.Informationen zu diesem Vorgang
Wenn Sie bereits Kunde sind und NIS-Abonnements mit Ihrem AWS-Konto verknüpft haben, empfiehlt NetApp den Wechsel zu einem eigenständigen Abonnement, um die Kosten Ihrer Cloud Volumes ONTAP Nutzung besser zu verwalten. Dies ist der vollständige Prozess:
...
. (Falls zutreffend) Konvertieren Sie Ihr Professional-Paket in ein Essentials-Paket und legen Sie die Abrechnungseinstellung fest. Siehe https://docs.netapp.com/us-en/console-licenses-subscriptions/task-manage-capacity-licenses.html#change-charging-methods["Ändern Sie die Abrechnungsmethoden für Kapazitätslizenzen"^] für Informationen zur Konvertierung Ihres Professional-Pakets in ein Essentials-Paket.
. Die Abrechnung von Datendiensten erfolgt weiterhin über Ihr NIS-Abonnement.


.Schritte
. Wählen Sie im linken Bereich der NetApp Console *Administration > Licenses and subscriptions > Billing preferences > Cloud Volumes ONTAP*.
. Wählen Sie auf der Registerkarte AWS das eigenständige Abonnement aus und klicken Sie auf das Optionssymbol image:screenshot_gallery_options.gif["Kebab-Symbol"].
. Im Fenster „Konfiguration bearbeiten“ wählen Sie die Abonnementnummer des eigenständigen Eintrags im Feld *AWS account credentials* aus.
. Klicken Sie auf *Konfigurieren*. Anschließend wird Ihnen das Abonnement als bevorzugte Option für Ihre Cloud Volumes ONTAP Abrechnung in AWS angezeigt.
. Bei der Bereitstellung eines neuen Cloud Volumes ONTAP Systems wählen Sie das Essentials-Paket, um über das Einzelabonnement abzurechnen. Weitere Informationen finden Sie unter  https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-quick-deploy-aws.html["Cloud Volumes ONTAP mit Schnellerstellung bereitstellen"^].


Wiederholen Sie die gleichen Schritte für das NIS-Abonnement auf der Registerkarte *Datendienste*, um das NIS-Abonnement für Ihre Datendienste zu nutzen. Wählen Sie bei der Bereitstellung eines neuen Cloud Volumes ONTAP-Systems das Professional-Paket aus, um die Abrechnung über das NIS-Abonnement vorzunehmen.
...
* https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/whats-new.html#end-of-availability-for-node-based-licenses["Ende der Verfügbarkeit knotenbasierter Lizenzen"^]
* https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-licensing.html#end-of-availability-of-node-based-licenses["Ende der Verfügbarkeit von knotenbasierten Lizenzen"^]
