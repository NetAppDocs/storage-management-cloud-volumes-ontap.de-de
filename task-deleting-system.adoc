...
.Schritte
. Wenn Sie die Sicherung und Wiederherstellung auf dem System aktiviert haben, prüfen Sie, ob die gesicherten Daten noch benötigt werden, und dann https://docs.netapp.com/us-en/data-services-backup-recovery/prev-ontap-backup-manage.html#delete-backups["Löschen Sie ggf. die Backups"^] Die
+
