...
+
Dieser Schritt ist erforderlich, wenn Sie Data Tiering auf Cloud Volumes ONTAP aktiviert haben und die im Amazon Simple Storage Service (Amazon S3) Bucket gespeicherten Daten verschlüsseln möchten.
